...
export const ROLES: Record<Role, RoleConfig> = {
  "super-admin": {
    ...
    nav: [
      ...
      { label: "Mistakes", icon: AlertTriangle, path: "/super-admin/error-reports" },
  ...
  admin: {
    ...
    nav: [
      ...
      { label: "Mistakes", icon: AlertTriangle, path: "/admin/error-reports" },
  ...
  supervisor: {
    ...
    nav: [
      ...
      { label: "Mistakes", icon: AlertTriangle, path: "/supervisor/error-reports" },
