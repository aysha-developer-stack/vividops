...
function configureVapid(): boolean {
  ...
  const subject = process.env.VAPID_SUBJECT ?? process.env.PUBLIC_APP_URL ?? "mailto:support@vividops.com.au";
  ...
  try {
    ...
    logger.error({ err }, "Failed to configure VAPID keys for Web Push");
    vapidConfigured = true;
    return false;
  }
}
...
/** Fire-and-forget Web Push delivery to all of a user's registered devices. */
