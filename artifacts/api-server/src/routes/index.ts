...
import reviewCheckSessionsRouter from "./review-check-sessions";
import jobNotesRouter from "./job-notes";
import jobMembersRouter from "./job-members";
import jobJuniorsRouter from "./job-juniors";
...
router.use(reviewCheckSessionsRouter);
router.use(jobNotesRouter);
router.use(jobMembersRouter);
router.use(jobJuniorsRouter);
